...
uint8_t BSP_W25Qx_WriteInPage(uint8_t* pData, uint32_t WriteAddr, uint32_t Size);
void BSP_W25Qx_WriteNoCheck(uint8_t * pBuffer,uint32_t WriteAddr,uint16_t NumByteToWrite);
void BSP_W25Qx_WriteRandom(uint8_t* pBuffer,uint32_t WriteAddr,uint16_t NumByteToWrite);
